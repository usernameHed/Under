...
public class MovePlayer : MonoBehaviour {
    ...
    void checkPowerChange()
    {
        ...
        if (    (powerType == 1 && !MapPrefs.PP.mapsInfosMulti[PlayerPrefs.PP.mapUnlockMulti].blue)
            ||  (powerType == 2 && !MapPrefs.PP.mapsInfosMulti[PlayerPrefs.PP.mapUnlockMulti].red)
            ||  (powerType == 3 && !MapPrefs.PP.mapsInfosMulti[PlayerPrefs.PP.mapUnlockMulti].yellow)
            ||  (powerType == 4 && !MapPrefs.PP.mapsInfosMulti[PlayerPrefs.PP.mapUnlockMulti].green)
                )
        {
            powerType++;
            checkPowerChange();
